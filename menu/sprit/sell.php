...
$output .= "<input type='number' required='required' min='0.01' step='0.01' name='price' placeholder='' class='sp_price sp tableTopInput'> " . getCurrency() . " <br/>";
$output .= "<input type='number' required='required' min='0.01' step='0.01' name='amount' placeholder='' class='sp_amount sp tableTopInput'> &#8467;<br/>";
